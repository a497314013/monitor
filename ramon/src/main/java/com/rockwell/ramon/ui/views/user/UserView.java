...
@PageTitle("User")
public class UserView extends VerticalLayout implements CrudListener<User> {// or implements LazyCrudListener<User> 
	/**
    ...
    public UserView(RoleDao roleDao,UserService userService) {
    ...
    {
    	GridCrud<User> crud = new GridCrud<>(User.class, this);
        ...
        modifyRoleButton.addClickListener(event->{
        	User user = crud.getGrid().asSingleSelect().getValue();
        ...
        /*formFactory.setErrorListener(e -> {
            ...
            new Notification(errorMessage).open();
        });*/
